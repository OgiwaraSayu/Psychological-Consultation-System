            ...
            <div>
                <el-card style="width: 70%;height:1900px;position: relative;left: 15%;padding: 20px">
                    <el-form
                        ...
                        label-width="100px"
                    >
                        <span class="titlestyle" style="position: relative;bottom: 20px"><span
                            class="iconstyle">|</span>&nbsp;&nbsp;个人身份信息填写</span>
                        <div>
                        ...
                        <div>
                            <span class="titlestyle" style="position: relative;top:60px;"><span
                                class="iconstyle">|</span>&nbsp;&nbsp;心理疾病急诊经历</span>
                        </div>
                        ...
                        <div>
                            <span class="titlestyle" style="position: relative;top:110px;"><span
                                class="iconstyle">|</span>&nbsp;&nbsp;自我状态估量表</span>
                        </div>
                        <div style="position: relative;top: 90px">
                            <el-row>
                                <el-col v-for="item in selfstatus" :key=item :span="8" style="margin-top: 20px">
                                    <el-checkbox @change="checked=>handleCheckAllchange(checked)">{{ item }}
                                    </el-checkbox>
                                </el-col>
                            </el-row>
                        </div>
                        <div>
                            <span class="titlestyle" style="position: relative;top:150px;"><span
                                class="iconstyle">|</span>&nbsp;&nbsp;个人生活评估表</span>
                        </div>
                        <div style="position: relative;top: 120px">
                            ...
                            <el-row v-for="life in lifequality" :key="life.life">
                                ...
                                <el-checkbox-group v-model="life.checked" :max="1">
                        ...
                        <div>
                            <span class="titlestyle" style="position: relative;top:170px;"><span
                                class="iconstyle">|</span>&nbsp;&nbsp;自述紧急程度</span>
                        </div>
                        ...
                        <div>
                            <span class="titlestyle" style="position: relative;top:220px;"><span
                                class="iconstyle">|</span>&nbsp;&nbsp;咨询经历</span>
                        </div>
